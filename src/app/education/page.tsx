    ...
    <Layout>
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Completed in Bangladesh with a strong foundation in analytical thinking, logic, and applied mathematics. My academic path at BRAC University helped shape my interest in problem-solving and technology.
          </p>
        </div>
      </div>
    </Layout>
